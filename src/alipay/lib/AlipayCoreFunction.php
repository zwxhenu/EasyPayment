...
class AlipayCoreFunction
{
     ...
     * 除去数组中的空值和签名参数
     *
     * @param array $para 签名参数组 return 去掉空值与签名参数后的新签名参数组
     * @return array
     */
     ...
     * 对数组排序
     *
     * @param array $para 排序前的数组 return 排序后的数组
     * @return mixed
     */
     ...
     * @param string $input_charset 编码格式。默认值：空值 return 远程输出的数据
     * @return mixed
     */
     ...
     *
     * @param string $url 指定URL完整路径地址
     * @param string $cacert_url 指定当前工作目录绝对路径 return 远程输出的数据
     * @return mixed
     */
     ...
     * @param string $_input_charset 输入的编码格式 return 编码后的字符串
     * @return mixed|string
     */
     ...
     * @param string $_input_charset 输入的解码格式 return 解码后的字符串
     * @return mixed|string
     */
     ...
     * @param string $key 私钥 return 签名结果
     * @return string
     */
